...
![This is an image depicting how an engineer might use Claude Code to evaluate the efficacy of agentic tools.](../images/10_2025091101.png)
...
![This graph measures the test set accuracy of human-written vs. Claude-optimized Slack MCP servers.](../images/10_2025091102.png)
...
![This graph measures the test set accuracy of human-written vs. Claude-optimized Asana MCP servers.](../images/10_2025091103.png)
...
![This code snippet depicts an example of a detailed tool response.](../images/10_2025091104.png)

Here’s an example of a concise tool response (72 tokens):

![This code snippet depicts a concise tool response.](../images/10_2025091105.png)
...
![This image depicts an example of a truncated tool response.](../images/10_2025091106.png)

Here’s an example of an unhelpful error response:

![This image depicts an example of an unhelpful tool response.](../images/10_2025091107.png)

Here’s an example of a helpful error response:

![This image depicts an example of a helpful error response.](../images/10_2025091108.png)
